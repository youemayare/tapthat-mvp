...
export default function SignupForm({ searchParams }: Props) {
  ...
  if (success) {
    return (
      <div className="bg-card text-card-foreground border border-border rounded-2xl p-8 backdrop-blur-sm text-center">
  ...
  return (
    <div className="bg-card text-card-foreground border border-border rounded-2xl p-8 backdrop-blur-sm">
      ...
      <p className="text-muted-foreground text-sm mb-8">Get started with Tayz for free</p>
        ...
        <div>
          ...
          <div className="relative">
            ...
            <button
              ...
              className="absolute right-4 top-1/2 -translate-y-1/2 text-muted-foreground hover:text-zinc-200 transition-colors"
            >
      ...
      <div className="relative my-6">
        ...
        <div className="relative flex justify-center text-xs uppercase">
          <span className="bg-background px-3 text-muted-foreground rounded">or</span>
        </div>
      </div>
      ...
      <button
        ...
        disabled={loading}
        className="w-full flex items-center justify-center gap-3 py-3 px-4 bg-card text-card-foreground hover:bg-accent text-accent-foreground border border-border disabled:opacity-60 text-foreground font-medium rounded-xl transition-all"
      >
