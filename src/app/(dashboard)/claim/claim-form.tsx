  ...
  return (
    <div className="text-center">
      ...
      <button
        onClick={handleClaim}
        disabled={loading}
        className="group w-full flex items-center justify-center gap-2 py-4 px-6 bg-indigo-600 hover:bg-indigo-500 disabled:opacity-60 text-foreground font-semibold rounded-2xl transition-all duration-200"
      >
        {loading ? (
