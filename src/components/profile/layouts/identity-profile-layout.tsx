    ...
    <div className="min-h-[100dvh] bg-background text-foreground flex flex-col relative w-full overflow-x-hidden">
      ...
      <div className="absolute top-4 right-4 z-50 flex items-center gap-3">
        ...
        <button 
          ...
          className="w-10 h-10 rounded-full flex items-center justify-center bg-background/40 backdrop-blur-md border border-white/10 hover:bg-background/60 transition-colors"
        >
